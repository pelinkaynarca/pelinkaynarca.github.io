...
const Footer = () => {
  return (
    <footer className="flex md:hidden bottom-0 fixed h-14 py-2 items-center justify-center bg-nav-bg backdrop-blur-sm z-10 w-screen rounded-t-3xl border-accent2 border-[1px] border-opacity-25">
